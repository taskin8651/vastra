  ...
  <div class="offcanvas offcanvas-start app-menu" tabindex="-1" id="mobileMenu" aria-labelledby="mobileMenuLabel">
    ...
    <div class="offcanvas-body app-menu-body">
      ...
      <nav class="app-menu-links" aria-label="Account navigation">
        ...
        <a href="wallet.html"><i class="bi bi-wallet2"></i><span>VE Wallet <b>₹250</b></span><i class="bi bi-chevron-right"></i></a>
        <a href="refer-earn.html"><i class="bi bi-people"></i><span>Refer &amp; Earn</span><i class="bi bi-chevron-right"></i></a>
        <a href="size-guide.html"><i class="bi bi-rulers"></i><span>Size Guide</span><i class="bi bi-chevron-right"></i></a>
        <a href="support.html"><i class="bi bi-headset"></i><span>Customer Support</span><i class="bi bi-chevron-right"></i></a>
        <a href="#"><i class="bi bi-info-circle"></i><span>About Us</span><i class="bi bi-chevron-right"></i></a>
        <a href="#"><i class="bi bi-file-earmark-text"></i><span>Terms &amp; Conditions</span><i class="bi bi-chevron-right"></i></a>
        <a href="#"><i class="bi bi-shield-check"></i><span>Privacy Policy</span><i class="bi bi-chevron-right"></i></a>
      </nav>
      ...
      <a class="app-menu-logout" href="index.html"><i class="bi bi-box-arrow-right"></i>Logout</a>
